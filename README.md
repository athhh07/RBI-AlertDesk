...
[![Live Demo](https://img.shields.io/badge/🚀%20Live%20Demo-Hugging%20Face-FFD21E?style=for-the-badge)](https://huggingface.co/spaces)
...
|---|---|---|
| 🏆 **Random Forest** | **87.50%** | **0.81** |
| Linear SVM | 85.42% | 0.79 |
| Logistic Regression | 83.33% | 0.71 |

**Selected: Random Forest** — best overall accuracy and strongest F1 on minority classes (INFO, URGENT).
...
2. Select **SDK: Streamlit** → name it `rbi-alert-desk`
3. Upload: `app.py`, `extractors.py`, `requirements.txt`, `models/`
4. Hugging Face builds and deploys automatically in ~3 minutes
